        ...
        return (
            <div className="relative" ref={setMenuRef(menuId)}>
                <button
                    ...
                    className={`${isSubcategory ? 'p-1.5' : 'p-2'} text-gray-500 hover:text-white hover:bg-white/10 rounded-lg transition-colors`}
                    aria-label={t('common.edit')}
                    aria-expanded={isOpen}
                    aria-haspopup="true"
                >
                    <Icons.DotsVertical className={isSubcategory ? 'w-3.5 h-3.5' : 'w-4 h-4'} />
                </button>
        ...
        <div className="rounded-xl overflow-visible">
            ...
            >
                ...
                <div className="text-right mr-1">
                    <p className={`text-sm font-semibold ${category.type === 'income' ? 'text-[#22c55e]' : 'text-[#ef4444]'}`}>
                ...
                <div className="bg-[#0f1610] border border-t-0 border-[#2a3f2a] rounded-b-xl overflow-visible">
                    {category.subcategories!.map((sub, index) => (
                        ...
                        >
                            ...
                            {/* Subcategory Amount */}
                            <p className={`text-xs font-medium ${category.type === 'income' ? 'text-[#22c55e]/70' : 'text-[#ef4444]/70'}`}>
